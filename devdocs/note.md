...
````
flutter pub add --dev analyzer build_runner build_verify change_app_package_name envied_generator flutter_launcher_icons go_router_builder injectable_generator isar_generator json_serializable
```